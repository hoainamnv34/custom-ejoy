...
Original Page: [URL]`,
    ...
    'mail-button': localStorage.getItem('mail-button') && (localStorage.getItem('mail-button') !== 'false'),
    'save-button': localStorage.getItem('save-button') && (localStorage.getItem('save-button') !== 'false'),
